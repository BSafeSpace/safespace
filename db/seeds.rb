...
questions = {mental_health: ["No issue: Seeking out peers", "Depression", "General Anxiety" , "Social Anxiety", "ADHD", "OCD", "Autistic", "Bipolar Disorder", "Post-traumatic Stress Disorder (PTSD)", "Grieving", "Addiction", "Insomnia", "Other"],
			...
			ethnicity: ["African or African American", "Chinese or Chinese American", "Filipino or Filipino American", "Vietnamese or Vietnamese American", "Mexican or Mexican American/ Chicano", "American Indian/ Alaska Native", "East Indian/ Pakistani","Japanese/ Japanese American", "Korean/ Korean American","Pacific Islander","Middle Eastern","White/ Caucasian","Latino/ Spanish American","Asian","Hispanic", "Other"],
